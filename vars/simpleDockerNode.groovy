...
def call(String dockerImageName, int timeoutInMinutes, Closure body) {
    simpleDockerNode(dockerImageName, null, null, 'latest', timeoutInMinutes, body)
}

// Runs a set of functionality on the default node
// that supports docker, with support for login to non-anonymous registry
// Parameters:
//  dockerImageName - Docker image to use
...
//  timeoutInMinutes - Timeout in minutes for the body
//  body - Closure, see example
def call(String dockerImageName, String dockerRegistryUrl, String registryCredentialsId, int timeoutInMinutes, Closure body) {
    simpleDockerNode(dockerImageName, dockerRegistryUrl, registryCredentialsId, 'latest', timeoutInMinutes, body)
}
...
def call(String dockerImageName, Closure body) {
    simpleDockerNode(dockerImageName, Constants.DEFAULT_PIPELINE_TIMEOUT, body)
}
...
//  registryCredentialsId - token for accessing registry at dockerRegistryUrl
//  body - Closure, see example
def call(String dockerImageName, String dockerRegistryUrl, String registryCredentialsId, Closure body) {
    simpleDockerNode(dockerImageName, dockerRegistryUrl, registryCredentialsId, 'latest', Constants.DEFAULT_PIPELINE_TIMEOUT, body)
}
...
def call(String dockerImageName, String hostVersion, Closure body) {
    simpleDockerNode(dockerImageName, null, null, hostVersion, Constants.DEFAULT_PIPELINE_TIMEOUT, body)
}
...
//  timeoutInMinutes - Timeout in minutes for the body
//  body - Closure, see example
def call(String dockerImageName, String dockerRegistryUrl, String registryCredentialsId, String hostVersion, Closure body) {
    simpleDockerNode(dockerImageName, dockerRegistryUrl, registryCredentialsId, hostVersion, Constants.DEFAULT_PIPELINE_TIMEOUT, body)
}
...
//  body - Closure, see example
def call(String dockerImageName, String dockerRegistryUrl, String registryCredentialsId, String hostVersion, Closure body) {
    call(dockerImageName, dockerRegistryUrl, registryCredentialsId, hostVersion, Constants.DEFAULT_PIPELINE_TIMEOUT, body)
}
...
def call(String dockerImageName, String hostVersion, int timeoutInMinutes, Closure body) {
    call(dockerImageName, null, null, hostVersion, timeoutInMinutes, body)
}
...
def call(String dockerImageName, String hostVersion, String dockerArgs, Closure body) {
    call(dockerImageName, null, null, hostVersion, Constants.DEFAULT_PIPELINE_TIMEOUT, dockerArgs, body)
}
...
//  timeoutInMinutes - Timeout in minutes for the body
//  body - Closure, see example
def call(String dockerImageName, String dockerRegistryUrl, String registryCredentialsId, String hostVersion, int timeoutInMinutes, Closure body) {
    call(dockerImageName, dockerRegistryUrl, registryCredentialsId, hostVersion, timeoutInMinutes, '', body)
}
